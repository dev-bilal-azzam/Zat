package com.devbilal.presentation.features.auth.setuppattern
        ...
        Column(
            modifier = Modifier
                ...
                .pointerInput(Unit) {
                    detectTapGestures {
                        onIntent(
                            SetupPatternIntent.OnPatternChanged(
                                emptyList()
                            )
                        )
                    }
            ...
            com.devbilal.presentation.features.auth.setuppattern.components.SetupPatternHeader()
