...
import com.devbilal.domain.exception.NotFoundDiaryEntryException
...
class GetDiaryEntryUseCase(
    ...
    suspend operator fun invoke(id: Uuid): DiaryEntry {
        return repository.getEntryById(id) ?: throw NotFoundDiaryEntryException("Diary entry not found")
    }
}
